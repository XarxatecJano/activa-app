...
const getOneStudentByUserId_js_1 = require("../handlers/student/getOneStudentByUserId.js");
const getStudentsData_js_1 = require("../handlers/student/getStudentsData.js");
...
studentRouter.get("/data", getStudentsData_js_1.getStudentsData);
studentRouter.get("/:id_student", validateToken_js_1.validateToken, getOneStudent_js_1.getOneStudent);
studentRouter.get("/userId/:id_user", getOneStudentByUserId_js_1.getOneStudentByUserId);
studentRouter.post("/", insertStudent_js_1.insertStudent);
